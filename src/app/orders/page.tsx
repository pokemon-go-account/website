        ...
        <div className="space-y-4">
          {allPurchases.map((purchase) => {
            ...
            return (
              <div
                key={purchase.id}
                className="rounded-2xl border border-zinc-200/80 bg-white hover:border-zinc-300 dark:border-white/[0.04] dark:bg-[#0d0d12]/40 dark:hover:border-white/[0.08] p-5 flex flex-col gap-4 transition-all duration-300 shadow-xs"
              >
