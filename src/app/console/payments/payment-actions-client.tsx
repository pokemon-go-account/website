    ...
    <>
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        <button
          ...
          className="inline-flex items-center gap-1 h-6 px-2 rounded border border-zinc-200 dark:border-zinc-700 text-[10px] font-semibold text-zinc-500 dark:text-zinc-400 hover:border-violet-400 hover:text-violet-600 dark:hover:text-violet-400 transition cursor-pointer bg-transparent"
        >
          ...
          <div className="relative bg-white dark:bg-[#111111] rounded-2xl border border-zinc-200 dark:border-white/[0.08] p-4 max-w-lg w-full shadow-2xl space-y-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-zinc-400 font-mono">UTR: {utrNumber}</p>
              </div>
