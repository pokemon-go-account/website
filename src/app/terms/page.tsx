      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 sm:py-24 space-y-12">
        ...
        <div className="space-y-10 text-sm leading-loose text-zinc-600 dark:text-zinc-400">
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">1. Acceptance of Terms</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">2. Eligibility</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">3. Account Registration</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">4. Auction Rules</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">5. Direct Storefront Purchases</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">6. Escrow Service & Payment</h2>
            <p>
              Winning bidders are required to complete payment within 24 hours of auction conclusion. All funds are held in secure custody by our platform system until successful delivery verification. Disputes must be raised within 48 hours of delivery. After this period, funds are released to the seller.
            </p>
          </section>

          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">7. Prohibited Conduct</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">8. Limitation of Liability</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">9. Modifications</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-base font-semibold text-zinc-900 dark:text-white">10. Contact</h2>
            <p>
