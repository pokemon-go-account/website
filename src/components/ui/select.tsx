...
function SelectValue({ className, ...props }: SelectPrimitive.Value.Props) {
  return (
    <SelectPrimitive.Value
      ...
      className={cn("flex flex-1 text-left data-[placeholder]:text-zinc-400 dark:data-[placeholder]:text-zinc-500", className)}
      {...props}
    />
  )
}
