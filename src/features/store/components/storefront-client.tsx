        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-28 space-y-2 max-h-[70vh] overflow-y-auto pr-2">
              <p className="text-[10px] font-extrabold text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.2em] mb-4 pl-3">
                Store Categories
              </p>
              {categories.map((cat) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeCategory === cat._id
                      ? "bg-white border-zinc-200 text-zinc-950 shadow-md dark:bg-white dark:border-white dark:text-black"
                      : "bg-transparent border-transparent text-zinc-500 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white"
                  )}
                >
                  {cat.name}
                </button>
          ...
          <div className="lg:col-span-3 space-y-16">
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  <h2 className="text-lg font-black text-zinc-900 dark:text-white border-b border-zinc-200 dark:border-white/[0.05] pb-2 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                    {catProducts.map((product) => (
                      <div
                        key={product._id}
                        className="group relative rounded-2xl border border-zinc-200/80 bg-white hover:border-zinc-300 dark:border-white/[0.04] dark:bg-white/[0.01] dark:hover:border-white/[0.09] dark:bg-white/[0.02] p-4 transition-all duration-300 flex flex-col justify-between hover:shadow-lg dark:hover:shadow-[0_0_20px_rgba(255,255,255,0.01)]"
                      >
