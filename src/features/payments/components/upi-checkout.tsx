...
export function UpiPaymentCheckout({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 items-stretch text-left">
      ...
      <div className="rounded-2xl border border-zinc-200/85 dark:border-white/[0.06] bg-zinc-50/50 dark:bg-[#151515]/30 p-5 flex flex-col justify-between space-y-4">
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-zinc-200/85 dark:border-white/[0.06] bg-zinc-50/50 dark:bg-[#151515]/30 p-5 flex flex-col justify-between space-y-4">
